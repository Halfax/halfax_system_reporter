@echo off
REM Build script for nvme_helper.exe on Windows
REM Requirements: Microsoft Visual C++ Build Tools or Visual Studio

echo Building nvme_helper.exe...

REM Try to use MSVC compiler if available
if exist "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvars64.bat" (
    call "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvars64.bat"
    cl.exe /O2 nvme_helper.c /link kernel32.lib setupapi.lib cfgmgr32.lib && (
        echo.
        echo Build successful! nvme_helper.exe created.
        exit /b 0
    ) || (
        echo.
...
if exist "C:\Program Files\mingw-w64\x86_64-8.1-posix-seh-rt_v6-rev0\mingw64\bin\gcc.exe" (
    ...
    gcc -O2 nvme_helper.c -o nvme_helper.exe -lsetupapi -lcfgmgr32 && (
        echo.
        echo Build successful with MinGW! nvme_helper.exe created.
        exit /b 0
    ) || (
        echo.
